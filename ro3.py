...
Options:
    A   data|expression 1 or unknown variable e.g. 3.1416 or "1+2*3" or X
    B   data|expression 2 or unknown variable e.g. 3.1416 or "1+2*3" or X
    C   data|expression 3 or unknown variable e.g. 3.1416 or "1+2*3" or X
    D   data|expression 4 or unknown variable e.g. 3.1416 or "1+2*3" or X
"""
